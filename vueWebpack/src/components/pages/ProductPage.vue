        ...
        <div class="jumbotron jumbotron-fluid banner-bg d-flex align-items-end">
            <div class="container">
                <div class="bg-lighter py-3 text-center d-none d-sm-block">
                    <h2 class="display-3 text-primary font-weight-bold letter-spacing">小資族的裝潢術</h2>
                    <p class="lead font-weight-bold text-info"><em>無論空間大小，都可以很有個性</em></p>
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="row">
            ...
            <div class="col-md-3 my-3">
                <div class="list-group sticky-top" style="top:10px;">
                    <a href="#pane-1" class="list-group-item list-group-item-action list-group-item-info active" data-toggle="list">
                        <i class="fas fa-meteor mr-2"></i>新品上市
                    </a>
                    <a href="#pane-2" class="list-group-item list-group-item-action list-group-item-info" data-toggle="list">
                        <i class="fas fa-stopwatch mr-2"></i>限時下殺
                    </a>
                    <a href="#" class="list-group-item list-group-item-action list-group-item-info" data-toggle="list">
            ...
            <div class="col-md-9">
                    ...
                    <div class="col-md-5">
                        <div class="input-group my-3">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-outline-info btn-sm" type="button" id="button-addon2">Search</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="tab-content">
                    <div class="tab-pane active" id="pane-1">
                        <div class="row">
                            <!--product card-->
                            <div class="col-lg-4  col-md-6 my-3" v-for="item in products" :key="item.id">
                                <div class="card h-100  border-0 box-shadow">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-baseline">
                                            <div class="h5 text-info" v-if="!item.price">原價 {{item.origin_price | currency}}</div>
                                            <del class="h6 text-secondary" v-if="item.price">原價 {{item.origin_price | currency}}</del>
                                            <div class="h4 text-right text-info" v-if="item.price">現在只要 {{item.price | currency}}</div>
                                        </div>
                                    </div>
                                    <div class=" card-footer d-flex">
                                        <button type="button" class="btn btn-outline-primary btn-sm" @click="getProduct(item.id)">
                    ...
                    <div class="tab-pane" id="pane-2">
                        <div class="row">
                            <div class="col-md-4 col-sm-6 my-3">
                                <div class="card h-100  border-0 box-shadow">
                                    <img src="https://images.unsplash.com/photo-1576161954389-69cb769e0eee?ixlib=rb-1.2.1&auto=format&fit=crop&w=676&q=80" class="card-img-top" alt="...">
                                    <div class="card-body text-center">
                                        <h5 class="card-title">氣氛燈泡花瓶</h5>
                                        <p class="card-text">This card has supporting text below as a natural lead-in to
                                            additional content.</p>
                                    </div>
                                    <div class="card-footer border-0 bg-white">
                                        <a href="#" class="btn btn-outline-secondary btn-sm btn-block">搶購去</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6 my-3">
                                <div class="card h-100  border-0 box-shadow">
                                    <img src="https://images.unsplash.com/photo-1463320898484-cdee8141c787?ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80" class="card-img-top" alt="...">
                                    <div class="card-body text-center">
                                        <h5 class="card-title">簡約盆栽-兩件組</h5>
                                        <p class="card-text">This card has supporting text below as a natural lead-in to
                                            additional content.</p>
                                    </div>
                                    <div class="card-footer border-0 bg-white">
                            ...
                            <div class="col-md-4 col-sm-6 my-3">
                                <div class="card h-100 border-0 box-shadow">
                                    <img src="https://images.unsplash.com/photo-1588622673923-83a6e5fe723d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=600&q=60" class="card-img-top" alt="...">
                                    <div class="card-body text-center">
                                        <h5 class="card-title">氣質金邊花瓶</h5>
                                        <p class="card-text">This card has supporting text below as a natural lead-in to
                                            additional content.</p>
                                    </div>
                                    <div class="card-footer border-0 bg-white">
